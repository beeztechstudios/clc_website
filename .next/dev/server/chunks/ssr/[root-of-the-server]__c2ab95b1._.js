...
async function getBlogPost(slug) {
  ...
  `;
    return await __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$project$2f$src$2f$lib$2f$sanity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["client"].fetch(query, {
        slug
    });
}
async function generateMetadata({ params }) {
    ...
    const description = blogPost.seo?.metaDescription || blogPost.excerpt || `Read ${blogPost.title} - Legal insights from Commercial Law Chamber`;
    const canonical = `https://www.clclaw.in/blog/${params.slug}`;
    const ogImage = blogPost.featuredImage ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$project$2f$src$2f$lib$2f$sanity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["urlFor"])(blogPost.featuredImage).width(1200).height(630).url() : "https://www.clclaw.in/clc-logo.png";
    return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2ab95b1._.js.map