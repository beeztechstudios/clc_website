...
// REMOVE: import { client } from "@/lib/sanity";
// REMOVE: import { queries } from "@/lib/sanity";
__turbopack_context__.s([
    "default",
    ()=>RightSidebar
]);
...
;
;
// REMOVE: async function fetchSidebarData() {...}
// REMOVE: async function RightSidebar() {...}
...
function RightSidebar({ featuredBlogs, featuredNews }) {
    // REMOVE: const { featuredBlogs, featuredNews } = await fetchSidebarData();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__47a78921._.js.map