...
async function generateMetadata({ params }) {
    const query = `*[_type == "newsUpdates" && slug.current == $slug][0]{
    title,
    excerpt,
    seo,
    slug,
    ...
    if (!data) {
        return {
            title: "Article Not Found | Commercial Law Chamber",
            description: "The requested article could not be found."
        };
    }
    const ogImage = data.featuredImage ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$project$2f$src$2f$lib$2f$sanity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["urlFor"])(data.featuredImage).width(1200).height(630).fit("crop").url() : "/clc-logo.png";
    return {
        title: `${data.seo?.metaTitle || data.title} | Commercial Law Chamber`,
        description: data.seo?.metaDescription || data.excerpt,
        keywords: `${data.type}, legal news, case updates, ${data.title}`,
        alternates: {
            canonical: `https://www.clclaw.in/news/${params.slug}`
        },
        openGraph: {
            title: data.title,
            description: data.seo?.metaDescription || data.excerpt,
            type: "article",
            url: `https://www.clclaw.in/news/${params.slug}`,
            images: [
                {
                    url: ogImage
                }
...
async function NewsPage({ params }) {
    const newsUpdate = await getNewsData(params.slug);
    ...
    const ogImage = newsUpdate.featuredImage ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$project$2f$src$2f$lib$2f$sanity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["urlFor"])(newsUpdate.featuredImage).width(800).height(400).fit("crop").url() : "/clc-logo.png";
    ...
    const jsonLd = {
        ...
        description: newsUpdate.excerpt,
        image: ogImage,
        ...
        mainEntityOfPage: {
            "@type": "WebPage",
            "@id": `https://www.clclaw.in/news/${params.slug}`
        },
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$project$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$project$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                                className: "text-3xl font-bold text-[#163C0F] mb-6",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$project$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("time", {
                                                className: "block text-sm text-gray-600 mb-4",
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(newsUpdate.publishedAt), "MMMM d, yyyy")
                                            }, void 0, false, {
                                                fileName: "[project]/my-project/src/app/news/[slug]/page.tsx",
                                                lineNumber: 174,
                                                columnNumber: 17
                                            }, this),
                                            newsUpdate.featuredImage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$project$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                src: ogImage,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5f865e8b._.js.map